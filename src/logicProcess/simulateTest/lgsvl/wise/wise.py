...
class DefaultAssets:
    # Map loaded in the quickstart scripts. Changing the mapper may lead to unexpected behaviour in the quickstart scripts. Default value is "BorregasAve".
    ...
    # Map loaded in the quickstart scripts. Changing the mapper may lead to unexpected behaviour in the quickstart scripts. Default value is "CubeTown".
    ...
    # Map loaded in some of the examples. Changing the mapper may lead to unexpected behaviour in the example scripts. Default value is "SanFrancisco".
    ...
    # Map loaded in some of the examples. Changing the mapper may lead to unexpected behaviour in the example scripts. Default value is "Straight1LanePedestrianCrosswalk".
    ...
    # Map loaded in some of the examples. Changing the mapper may lead to unexpected behaviour in the example scripts. Default value is "SingleLaneRoad".
    ...
    # Map loaded in some of the examples. Changing the mapper may lead to unexpected behaviour in the example scripts. Default value is "Straight1LaneSame".
    ...
    # Map loaded in some of the examples. Changing the mapper may lead to unexpected behaviour in the example scripts. Default value is "Straight2LaneSame".
    ...
    # Map loaded in some of the examples. Changing the mapper may lead to unexpected behaviour in the example scripts. Default value is "Straight2LaneSameCurbRightIntersection".
    ...
    # Map loaded in some of the examples. Changing the mapper may lead to unexpected behaviour in the example scripts. Default value is "Straight2LaneOpposing".
    ...
    # Map loaded in the quickstart scripts. Changing the mapper may lead to unexpected behaviour in the quickstart scripts. Default value is "LGSeocho".
