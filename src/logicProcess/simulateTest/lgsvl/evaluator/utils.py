...
def right_lane_check(simulator, ego_transform):
    ...
    right = logicProcess.simulateTest.lgsvl.utils.transform_to_right(ego_transform)
...
def in_parking_zone(beginning, end, ego_transform):
    forward = logicProcess.simulateTest.lgsvl.utils.transform_to_forward(ego_transform)
