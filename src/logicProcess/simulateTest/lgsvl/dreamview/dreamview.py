...
class Connection:
    ...
    def set_hd_map(self, hd_map):
        """
        Folders in /apollo/modules/mapper/data/ are the available HD maps
        ...
        if not self.get_current_map() == mapped_map:
            ...
            error_message = (
                ...
                "/apollo/modules/mapper/data/{1} and restart Dreamview -- Aborting..."
            )
            log.error(
    ...
    def get_module_status(self):
        ...
        #   the current mapper, vehicle, and mode:
    ...
    def get_current_map(self):
        ...
        try:
            ...
            log.error("Not able to get the current HD mapper loaded in Dreamview.")
